...
if (isset($_GET['download']) and $_GET['download'] == 'true') {
    ...
    if ( ! function_exists('show_sub_categories')) {
        function show_sub_categories($sub_categories)
        {
    ...
    <head>
        ...
        <style type="text/css">
            ...
            .dropdown-menu li a {
                ...
                white-space: nowrap;
                display: block;
                width: 100%; /* Або за потреби вказати ширину примусово */
                /*max-width: 250px; !* Вказати ширину елемента, якщо потрібно *!*/
            }
            ...
            /* submenu */
            .has-child .sub-categories {
                position: absolute;
                top: 0;
                left: 100%;
                width: 200px;
                background: #fff;
                box-shadow: 0 4px 16px rgba(60, 60, 80, 0.13);
                z-index: 100;
                opacity: 0;
                pointer-events: none;
            ...
            /* show subcategories */
            .has-child:hover .sub-categories,
            .has-child:focus-within .sub-categories {
                opacity: 1;
                pointer-events: auto;
            ...
            .cabinet:hover .form-login,
            .cabinet:focus-within .form-login {
                opacity: 1;
                pointer-events: auto;
                transform: translateY(50px);
                visibility: visible;
                ...
                <ul class="nav navbar-nav">
                    <li class="cabinet">
                        ...
                        <section class="form-login">
                            <div class="title">
                                <span class="active">First Name</span><span>Settings</span>
                            </div>
                            <form>
                                <div class="form-group">
                                    <label for="label">Label</label>
                                    <input type="text" id="label" value="First Name"/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group checkbox-group">
                                    ...
                                    <input type="checkbox" id="required" class="custom-checkbox"/>
                                </div>
                            </form>
                        </section>
                    </li>
                        ...
                        <ul class="dropdown-menu">
                            <?php foreach ($categories as $category) {
                                if ($category === 'Комп`ютери') {
                                    echo '<li class="has-child"><a href="#">'.$category.'<span class="caret"></span></a>';
